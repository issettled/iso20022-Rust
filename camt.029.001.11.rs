...
pub struct CancellationStatusReason4 {
	...
	#[serde(rename = "Rsn")]
	pub rsn: CancellationStatusReason3Choice,
...
pub struct ChargeType3Choice {
	...
	pub cd: String,
	#[serde(rename = "Prtry")]
	pub prtry: GenericIdentification3,
}
...
pub struct ClaimNonReceipt2 {
	...
	pub orgnl_nxt_agt: BranchAndFinancialInstitutionIdentification6,
}
...
pub struct ClaimNonReceipt2Choice {
	#[serde(rename = "Accptd")]
	pub accptd: ClaimNonReceipt2,
	#[serde(rename = "Rjctd")]
	pub rjctd: ClaimNonReceiptRejectReason1Choice,
}
...
pub struct CorrectiveInterbankTransaction3 {
	#[serde(rename = "GrpHdr")]
	pub grp_hdr: CorrectiveGroupInformation1,
...
pub struct CorrectiveTransaction5Choice {
	#[serde(rename = "Initn")]
	pub initn: CorrectivePaymentInitiation5,
	#[serde(rename = "IntrBk")]
	pub intr_bk: CorrectiveInterbankTransaction3,
}
...
pub struct InvestigationStatus5Choice {
	...
	pub rjctd_mod: Vec<ModificationStatusReason1Choice>,
	#[serde(rename = "DplctOf")]
	pub dplct_of: Case5,
	#[serde(rename = "AssgnmtCxlConf")]
	pub assgnmt_cxl_conf: bool,
}
...
pub struct ModificationStatusReason2 {
	...
	pub orgtr: PartyIdentification135,
	#[serde(rename = "Rsn")]
	pub rsn: ModificationStatusReason1Choice,
	#[serde(rename = "AddtlInf")]
	pub addtl_inf: Vec<String>,
}
...
pub struct OriginalGroupHeader14 {
	...
	pub orgnl_grp_cxl_id: String,
	#[serde(rename = "RslvdCase")]
	pub rslvd_case: Case5,
	...
	pub orgnl_ctrl_sum: f64,
	#[serde(rename = "GrpCxlSts")]
	pub grp_cxl_sts: String,
...
pub struct OriginalPaymentInstruction43 {
	...
	pub orgnl_pmt_inf_cxl_id: String,
	#[serde(rename = "RslvdCase")]
	pub rslvd_case: Case5,
...
pub struct PaymentTransaction132 {
	...
	pub rsltn_rltd_inf: ResolutionData3,
...
pub struct ResolutionOfInvestigationV11 {
	...
	pub mod_dtls: PaymentTransaction132,
	#[serde(rename = "ClmNonRctDtls")]
	pub clm_non_rct_dtls: ClaimNonReceipt2Choice,
	#[serde(rename = "StmtDtls")]
	pub stmt_dtls: StatementResolutionEntry4,
	#[serde(rename = "CrrctnTx")]
	pub crrctn_tx: CorrectiveTransaction5Choice,
	#[serde(rename = "RsltnRltdInf")]
	pub rsltn_rltd_inf: ResolutionData3,
...
pub struct StatementResolutionEntry4 {
	...
	pub crrctd_amt: ActiveOrHistoricCurrencyAndAmount,
	#[serde(rename = "Chrgs")]
...
pub struct UnderlyingTransaction29 {
	...
	pub orgnl_grp_inf_and_sts: OriginalGroupHeader14,
