...
// AMLIndicator 
#[derive(Debug, Deserialize, Serialize, PartialEq)]
pub struct AMLIndicator {
	#[serde(rename = "AMLIndicator")]
	pub aml_indicator: bool,
}
...
#[derive(Debug, Deserialize, Serialize, PartialEq)]
pub struct ExternalUnableToApplyIncorrectData1Code {
	#[serde(rename = "ExternalUnableToApplyIncorrectData1Code")]
	pub external_unable_to_apply_incorrect_data1_code: String,
}


// ExternalUnableToApplyMissingData1Code 
#[derive(Debug, Deserialize, Serialize, PartialEq)]
pub struct ExternalUnableToApplyMissingData1Code {
	#[serde(rename = "ExternalUnableToApplyMissingData1Code")]
	pub external_unable_to_apply_missing_data1_code: String,
}
...
pub struct MissingOrIncorrectData1 {
	#[serde(rename = "AMLReq")]
	pub aml_req: bool,
	#[serde(rename = "MssngInf")]
	pub mssng_inf: Vec<UnableToApplyMissing2>,
	#[serde(rename = "IncrrctInf")]
	pub incrrct_inf: Vec<UnableToApplyIncorrect2>,
}
...
pub struct UnableToApplyIncorrect2 {
	...
	#[serde(rename = "AddtlIncrrctInf")]
	pub addtl_incrrct_inf: String,
}
...
pub struct UnableToApplyJustification4Choice {
	#[serde(rename = "AnyInf")]
	pub any_inf: bool,
	#[serde(rename = "MssngOrIncrrctInf")]
	pub mssng_or_incrrct_inf: MissingOrIncorrectData1,
	#[serde(rename = "PssblDplctInstr")]
	pub pssbl_dplct_instr: bool,
}
...
pub struct UnableToApplyMissing2 {
	...
	#[serde(rename = "AddtlMssngInf")]
	pub addtl_mssng_inf: String,
}


// UnableToApplyV09 
#[derive(Debug, Deserialize, Serialize, PartialEq)]
pub struct UnableToApplyV09 {
	...
	#[serde(rename = "Justfn")]
	pub justfn: UnableToApplyJustification4Choice,
