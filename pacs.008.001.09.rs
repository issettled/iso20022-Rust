...
#[derive(Debug, Deserialize, Serialize, PartialEq)]
pub struct CreditTransferTransaction43 {
	#[serde(rename = "PmtId")]
...
#[derive(Debug, Deserialize, Serialize, PartialEq)]
pub struct FIToFICustomerCreditTransferV09 {
	#[serde(rename = "GrpHdr")]
	pub grp_hdr: GroupHeader93,
	#[serde(rename = "CdtTrfTxInf")]
	pub cdt_trf_tx_inf: Vec<CreditTransferTransaction43>,
	#[serde(rename = "SplmtryData")]
	pub splmtry_data: Vec<SupplementaryData1>,
}
