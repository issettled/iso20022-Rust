...
#[derive(Debug, Deserialize, Serialize, PartialEq)]
pub struct CaseForwardingNotification3Code {
	#[serde(rename = "CaseForwardingNotification3Code")]
	pub case_forwarding_notification3_code: String,
}
...
#[derive(Debug, Deserialize, Serialize, PartialEq)]
pub struct NotificationOfCaseAssignmentV05 {
	#[serde(rename = "Hdr")]
	pub hdr: ReportHeader5,
	#[serde(rename = "Case")]
	pub case: Case5,
	#[serde(rename = "Assgnmt")]
	pub assgnmt: CaseAssignment5,
	#[serde(rename = "Ntfctn")]
	pub ntfctn: CaseForwardingNotification3,
...
// ReportHeader5 
#[derive(Debug, Deserialize, Serialize, PartialEq)]
pub struct ReportHeader5 {
	#[serde(rename = "Id")]
	pub id: String,
	#[serde(rename = "Fr")]
	pub fr: Party40Choice,
	#[serde(rename = "To")]
	pub to: Party40Choice,
	#[serde(rename = "CreDtTm")]
	pub cre_dt_tm: u8,
}
